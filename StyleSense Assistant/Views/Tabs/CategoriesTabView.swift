...
extension CategoriesTabView: UICollectionViewDataSource {
  ...
  {
    let cell =
      categoriesCollectionView.dequeueReusableCell(
        withReuseIdentifier: CategoriesTableCell.reusableId, for: indexPath) as! CategoriesTableCell
  ...
  private func updateCollectionViewLayout() {
    ...
    let width =
      (categoriesCollectionView.bounds.width - layout.minimumInteritemSpacing
